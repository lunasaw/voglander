...
(
    ...
    `vhost`         VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin  NOT NULL DEFAULT '__defaultVhost__' COMMENT '虚拟主机',
    `retry_count`   INT                                                     NOT NULL DEFAULT -1 COMMENT '重试次数，-1表示无限重试',
    `rtp_type`      INT                                                     NOT NULL DEFAULT 0 COMMENT 'rtsp推流方式，0:tcp，1:udp',
    `timeout_sec`   INT                                                     NOT NULL DEFAULT 10 COMMENT '推流超时时间，单位秒',
    `status`        INT                                                     NOT NULL DEFAULT 1 COMMENT '状态 1正常 0异常',
    `online_status` INT                                                     NOT NULL DEFAULT 0 COMMENT '在线状态 1在线 0离线',
    `proxy_key`     VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin           DEFAULT NULL COMMENT '代理密钥',
