package io.github.lunasaw.project.web.tools.http;

import com.luna.common.reflect.ConvertUtil;
import com.luna.common.text.StringTools;
import io.github.lunasaw.project.common.constant.Constants;
...
public class ServletUtils {
    ...
    public static Map<String, String> getParamMap(ServletRequest request) {
        ...
        for (Map.Entry<String, String[]> entry : getParams(request).entrySet()) {
            params.put(entry.getKey(), StringTools.join(entry.getValue(), ","));
        }
        return params;
    }
    ...
    public static boolean isAjaxRequest(HttpServletRequest request) {
        ...
        if (StringTools.containsAnyIgnoreCase(uri, ".json", ".xml")) {
            return true;
        }
