...
public class ImageCollectionWebAssembler {
    public ImageCollectionVO toVO(ImageCollectionEnrichedDTO source) {
        ...
        vo.setTaskId(task.getTaskId()); vo.setTaskName(task.getTaskName()); vo.setTaskMode(task.getTaskMode()); vo.setState(task.getState());
        ...
        vo.setMissedCount(task.getMissedCount()); vo.setProgressCurrent(task.getProgressCurrent()); vo.setProgressTotal(task.getProgressTotal());
